...
/*
@desc Sum of two poses. p2 represents an increment. This function adds the p2 increment on top of the p1 pose.
*/
...
/*
@desc Difference between two poses. Computes the coordinates of P1 in the coordinate frame where P2 is the origin.
*/
...
RobotPose GetRobotPoseFromMatrix(Matrix4 matrix) {
  ...
  double theta = atan2(matrix.storage[1], matrix.storage[0]); // Compute theta
